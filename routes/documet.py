...
from .login import admin_required  # اگر می‌خوای حذف فقط دست ادمین باشد
...
# حذف فایل فقط برای ادمین
@document_bp.route("/delete/<filename>", methods=["POST"])
@admin_required
@login_required
